  ...
  <div class="card">
   ...
   <div class="card-body">
    <div class="table-responsive">
     ...
     <table class="table table-striped table-bordered" id="time">
      <thead>
       <tr>
        <th>Student Name</th>
        <th>Roll Number</th>
...
<?php
  $query = "
  SELECT * FROM Subject_table WHERE Unitid = (SELECT id FROM users
    ...
    <form method="post" id="attendance_form">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          WHERE student_Unitid = '".$row["Unitid"]."'
          ";
          ...
          ?>
                <tr>
                  <td><?php echo $student["std_roll_no"]; ?></td>
                  <td>
                    <?php echo $student["student_name"]; ?>
                    <input type="hidden" name="std_roll_no[]" value="<?php echo $student["std_roll_no"]; ?>" />
                  </td>
                  <td align="center">
                    <input type="radio" name="Attendance<?php echo $student["std_roll_no"]; ?>" value="P" />
                  </td>
                  <td align="center">
                    <input type="radio" name="Attendance<?php echo $student["std_roll_no"]; ?>" checked value="A" />
                  </td>
                </tr>
          <?php
          }
...
<div class="modal" id="reportModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
        <input type="hidden" name="std_roll_no" id="std_roll_no" />
